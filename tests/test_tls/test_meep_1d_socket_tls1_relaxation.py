...
@pytest.mark.core
def test_1d_1tls_relaxation_matches_analytical_via_socket_v2(plotting=False):
    """
    End-to-end (socket) TLS relaxation test.
...
@pytest.mark.core
def test_1d_1tls_relaxation_numerical_polarization_matches_analytical_via_socket_v2(
    plotting=False,
):
    """
    End-to-end (socket) TLS relaxation test.
...
@pytest.mark.core
def test_1d_1tls_relaxation_point_dipole_matches_analytical_via_socket_v2(
    plotting=False,
):
    """
    End-to-end (socket) TLS relaxation test.
